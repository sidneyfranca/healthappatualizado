...
import { StyleSheet, View, Image, TouchableOpacity, Text, TextInput, navigation } from 'react-native';
    ...
    const onLogin = ({navigation}) => {
        ...
        return (
          <View style={styles.container}>
            ...
            <TouchableOpacity onPress={onLogin} style={[styles.buttonContainer, styles.loginButton]}>
